...
//get category by id
export const getCustomerById = async (id: any,selectType: any) => {
  console.log(" Get Select Type By ID ", id, selectType);
  const response = await axios.get(`${url}${selectType}/${id}`, {
    headers: {
      "Content-Type": "application/json",
    },
  });
  console.log(" Get Select Type Response ", response?.data);
  return response?.data;
};

export const getTankById = async (id: any,selectType:any) => {
  console.log(" Get Select Type By ID ", id,selectType);
  const response = await axios.get(`${url}${selectType}/${id}`, {
    headers: {
      "Content-Type": "application/json",
